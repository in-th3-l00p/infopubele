<x-guest-layout>
    <x-text-card>
        ...
        <br>
        <p>Într-o lume în care protejarea mediului înconjurător este o prioritate, companiile care se implică în reciclarea selectivă a deșeurilor joacă un rol esențial în reducerea impactului negativ asupra mediului.<br>
        <p>Mems Corporation SRL, prin infopuble.ro, oferă o soluție ecologică și eficientă pentru colectarea selectivă a deșeurilor (menajer, sticlă, carton și plastic), propunăndu-și să transforme gestionarea deșeurilor într-un proces simplu, inteligent și sustenabil, și să contribuie la reducerea cantității de deșeuri care ajung în depozitele de gunoi sau în natură.<br>
        ...
        <ol class="list-decimal ml-12 space-y-2">
            <li>cantitatea de deșeu aruncată, diferențiat pe categoriile – deșeu menajer - sticlă - carton – plastic
            <li>și poate fi taxată în funcție de căt a aruncat – “Plătești cât arunci”.
        </ol>
        <br>
        ...
        <br>
        <p>Astfel,<b class="font-extrabold"> fiecare persoană înregistrată </b> are un cont personal în care poate vedea cantitatea de deșeuri aruncate pe categorii (hârtie, plastic, sticlă, deșeuri menajere etc.) și costul asociat fiecărei categorii.
        </p>
        <br>
        <p>
            In același timp, utilizatorii pot monitoriza în timp real impactul lor asupra mediului și pot lua măsuri pentru a reduce cantitatea de deșeuri generate.
        </p>
        <br>
        ...
        <br>
        <p class="font-extrabold pb-10">Infopubele.ro reprezintă o soluție inovatoare și eficientă pentru colectarea selectivă a deșeurilor, promovând transparența, responsabilitatea și implicarea fiecărei persoane în protejarea mediului înconjurător.        </p>
        <p class="font-extrabold pb-10">Prin utilizarea tehnologiei și a unei abordări inovatoare, Infopubele.ro își propune să transforme gestionarea deșeurilor într-un proces simplu, inteligent și sustenabil.</p>
    </x-text-card>
    <x-footer/>
</x-guest-layout>
